...
description: A mixed-media artgame that blends film photography with hand-drawn animation to explore a city and one's inner self.
date: 2025-07-11
author: marmaestro
source:
    url: https://marmaestro.itch.io/stillilinger
    item: 'itch.io'
image: /src/assets/portfolio/tfg/tfg-banner.gif
roles: [ solo dev ]
tags: [ game, film photography ]
pinned: false
lang: en
---

import { Image } from 'astro:assets';
import banner from '../../../src/assets/portfolio/tfg/tfg-banner.gif';
import cafe from '../../../src/assets/portfolio/tfg/tfg-cafe.jpg';
